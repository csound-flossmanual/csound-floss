...
% Truncate headers to prevent overflow
\fancyhead[LE,RO]{\robotocondensed\color{titlecolor}\textsl{\truncate{0.45\textwidth}{\rightmark}}}
\fancyhead[LO,RE]{\robotocondensed\color{titlecolor}\textsl{\truncate{0.45\textwidth}{\leftmark}}}
...
% Define pandocbounded command for Pandoc 3.x compatibility
\newcommand{\pandocbounded}[1]{#1}

% Fix "Too deeply nested" error by redefining quote environment
% Use a simpler quote environment that doesn't nest as deeply
\renewenvironment{quote}%
  {\par\addvspace{\baselineskip}%
   \leftskip=2em\rightskip=2em\small}%
  {\par\addvspace{\baselineskip}}

% Increase maximum nesting depth for lists
\makeatletter
\setcounter{secnumdepth}{6}
\makeatother

\usepackage{titlesec}
\titleformat{\chapter}[display] {\normalfont\bfseries}{}{0pt}{\fontsize{20}{22}}
\titleformat{\section}[display]{\normalfont\bfseries}{}{0pt}{\fontsize{16}{19}}
\titleformat{\subsection}[display]{\normalfont\bfseries}{}{0pt}{\fontsize{14}{16}}
