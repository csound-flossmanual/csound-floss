...
This opcodes generates random numbers in a certain density, and draws lines
...
Another paradigm of random is the *random walk*. This means that each new random
value depends on the previous one, rather than being independent as in throwing
the dies or generating noise.
