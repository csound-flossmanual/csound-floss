...
But it can be also an essential part of our invention that we create _structures_
...
- We cannot perform any _k-rate_ or _a-rate_ expressions.
...
And the _random walk_ is only one possibility of a random which depends on
