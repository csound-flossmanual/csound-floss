...
and a fade-out from 1 to 0 in 0.5 seconds, over the whole duration **p3**
of the instrument event.
...
amplitude, or a signal. This is the case here for *aSine* as amplitude input.
...
Acoustically linear fades are not the best. We will discuss the reasons in
