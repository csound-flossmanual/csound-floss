...
_(see also chapter [04D](04-d-frequency-modulation.md))_
...
_(see also chapter [05G](05-g-granular-synthesis.md))_
...
_Note that GUI elements are provided by all frontends. Usage of the built-in FLTK widgets has limitations and is in general not recommended._
