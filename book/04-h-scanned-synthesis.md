...
opcode
*[scantable](https://csound.com/docs/manual/scantable.html "Steven Yi's Page on experimenting with Scanned Synthesis").*
...
The opcodes
[*scans*](https://csound.com/docs/manual/scans.html "Steven Yi's Page on experimenting with Scanned Synthesis")
and
[*scanu*](https://csound.com/docs/manual/scanu.html "Steven Yi's Page on experimenting with Scanned Synthesis")
...
Reference
Manual](https://csound.com/docs/manual/scanu.html "Steven Yi's Page on experimenting with Scanned Synthesis");
...
*[xscans](https://csound.com/docs/manual/xscans.html "Steven Yi's Page on experimenting with Scanned Synthesis"),
[xscanu](https://csound.com/docs/manual/xscanu.html "Steven Yi's Page on experimenting with Scanned Synthesis")*,
...
[GEN10](https://csound.com/docs/manual/GEN10.html "Steven Yi's Page on experimenting with Scanned Synthesis")
(sines), [GEN
21](https://csound.com/docs/manual/GEN21.html "Steven Yi's Page on experimenting with Scanned Synthesis")
(noise) and [GEN
27](https://csound.com/docs/manual/GEN27.html "Steven Yi's Page on experimenting with Scanned Synthesis")
...
We could then use
[*oscil*](https://csound.com/docs/manual/oscil.html "Steven Yi's Page on experimenting with Scanned Synthesis")
...
23](https://csound.com/docs/manual/GEN23.html "Steven Yi's Page on experimenting with Scanned Synthesis")
...
[balance](https://csound.com/docs/manual/balance.html "Steven Yi's Page on experimenting with Scanned Synthesis")
