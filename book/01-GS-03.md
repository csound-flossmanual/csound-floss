...
is the control rate or ***k-rate***. The time interval in 
...
- Change the values of the *kAmp* signal so that you get an increasing rather than a 
...
and *ksmps* are set in PD, and how they are called in PD. This comparision may
