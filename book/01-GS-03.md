...
is the control rate or **_k-rate_**. The time interval in
which the little statues arrive one by one is the audio-rate or **_a-rate_**.
...
At first, all Csound code is visible to anyone. Currently the
[source code](https://github.com/csound/csound) is on [Github](https://github.com).
...
the [Csound website](https://csound.com), for maintaining
...
If you like to read more about some of my own experiences and views, have a look
[here](https://joachimheintz.de/globales/2017_keynote_en.pdf).
