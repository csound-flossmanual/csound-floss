...
- What **k-rate** means and 
- What **k-variables** in Csound are.
- How a Csound **.csd document** is structured:
- What **CsOptions** are an
- What the **orchestra** is called.


## A Line for the Frequency

In natural sounds, the frequency is rarely fixed.
Usually, for instance when we speak, the pitch of our voice all the time, 
in a certain range. 
...
Note: Acoustically this way to apply a *glissando* is questionable.
...
But why is the variable on the left side called ***k**Freq*, and why is 
...
MAKE DRAWING HERE! audio rate vs control rate
...
I recommend using **k** or **a** at **both** positions:  
...
- Make the time of the *glissando* or ramp longer or shorter.  
...
maximum clarity. In the 
[Csound Book](https://link.springer.com/book/10.1007/978-3-319-45370-5) 
