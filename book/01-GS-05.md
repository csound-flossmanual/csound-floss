...
Our **perception** follows **ratios**. We will get back to this in the
[next tutorial](/get-started/GS-06).
...
6 seconds for the *Pitches_1* line. This is correct for a constant pitch
decay. We have two octaves which are crossed in 12 seconds, so each octave
needs 6 seconds. The 
*Pitches_2* line, however, reaches MIDI note 69 after 8 seconds, therefore
needing 2/3 of the overall time to cross the first octave, and only 1/3 
