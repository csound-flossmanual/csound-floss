...
(You can find some descriptions and comparisions [here](02-opcodes.md).)
...
frequency.
The [Csound Reference Manual](https://csound.com/docs/manual/index.html) contains all
the information about it.
In [Tutorial 08](01-GS-08.md) we will give some help on how to use it.
...
But back to the question: What is elementary about sine waves?
...
This means: All other sounds can be understood as the addition of simple sine
...
can somehow be understood as the most elementary sounds, at least in the world
of pitches.
...
1. We are all familiar with this way to declare a left hand side variable `y`
   ...
   signal flow, input arguments, or parameters. Whatever lets you feel more
...
2. As mentioned above, most other programming languages use a similar syntax,
   ...
   other programming language, it helps in learning Csound.
...
4. Whenever we want to use an expression as argument (you will learn more about
   ...
   to use it as consistently as possible.
...
So I took this as an oracle and decided for 5+3 headings, in order to also fulfill
...
the example: As easy as it is to just push the "Run" button, as hard will it
...
of 24 Tutorials, then finally the goal has been reached to **learn Csound in one day**.
...
Be it live coding, Bela Board or Raspberry Pi, be it noise music or the most
soft and subtle sounds, be it fixed media or the fastest possible real-time
application, be it using Csound as standalone or as a plugin to your preferred DAW.
