...
We will call this signal _aSine_ because it is an audio signal. The character **a**
...
thing in the world reliable, each _must read_ consists of five headings, and each
&nbsp;_can read_ of three. Actually I planned it to be 4+3, but then I asked Csound,
